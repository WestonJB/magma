...
/***************************************************************************//**
    ...
    ZSYTRF_AASEN computes the factorization of a complex symmetric matrix A
    ...
    @ingroup magma_sytrf_aasen
*******************************************************************************/
extern "C" magma_int_t
magma_zsytrf_aasen(magma_uplo_t uplo, magma_int_t cpu_panel, magma_int_t n,
    ...
    //} else 
    {
        ...
        if (upper) {
            ...
            for (magma_int_t j=0; j < magma_ceildiv(n, nb); j ++) {
                ...
                for (magma_int_t i=1; i < j; i++)
                {
                    ...
                    magmablas_zgeadd(nb, jb, 
                                    -c_half, dX(i), nb,
                                             dY(i), nb,
                                    queues[(i-1)%2]);
                    // transpose W for calling zsyr2k
                ...
                trace_gpu_start( 0, 0, "syr2k", "compTjj" );
                if (j > 1)
                magma_zsyr2k( MagmaLower, MagmaNoTrans,
                              jb, (j-1)*nb,
