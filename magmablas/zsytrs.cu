...
/***************************************************************************//**
    Purpose
    -------
    ZSYTRS solves a system of linear equations dA*dX = dB with a complex
    symmetric matrix dA using the factorization dA = dU*dD*dU**H or
    dA = dL*dD*dL**H computed by ZSYTRF_GPU.
    ...
    dA      COMPLEX_16 array, dimension (LDA,N)
            ...
            obtain the factor U or L as computed by ZSYTRF_GPU.
